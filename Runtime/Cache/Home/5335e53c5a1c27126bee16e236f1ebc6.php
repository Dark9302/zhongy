...
<link rel="stylesheet" href="/xiangm/Public/muban/assets/css/bootstrap.css">
	...
	<!-- <link href="/xiangm/Public/bootstrap/css/bootstrap.min.css" rel="stylesheet"> -->
	<!-- 自己写的css -->
	<link rel="stylesheet" type="text/css" href="/xiangm/Public/yeMiancss/kaiFang1.css">
	<!-- bootstrap的引用 -->
    <!-- <script src="/xiangm/Public/bootstrap/js/bootstrap.min.js"></script> -->
...
<div class="wrap-fluid" style="height: 85%;">
	...
	<div style="height:100%; width:100%;">
		...
		<div class="zhongjianhanzi">
				<img src="/xiangm/Public/img/iconpng.png" class="zhongjianhanziimg" alt="图片加载中。。。。">
