...
<!-- Le styles -->
<script type="text/javascript" src="/xiangm/Public/muban/assets/js/jquery.min.js"></script>
...
<link rel="stylesheet" href="/xiangm/Public/muban/assets/css/signin.css">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				<div class="account-box">
					<form role="form" action="/xiangm/index.php/Home/Index/home">
...
<div id="test1" class="gmap3">
	<!-- <img src="/xiangm/Public/" alt="background"> -->
</div>
<!--  END OF PAPER WRAP -->
<!-- MAIN EFFECT -->
<script type="text/javascript" src="/xiangm/Public/muban/assets/js/preloader.js"></script>
...
<script type="text/javascript" src="/xiangm/Public/muban/assets/js/map/gmap3.js"></script>
